...
class Student extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['first_name', 'last_name', 'birth_date', 'title'], 'required'],
            [['birth_date', 'create_date', 'update_date'], 'safe'],
            [['sex', 'remarks', 'record_status', 'title'], 'string'],
            [['create_user_id', 'update_user_id'], 'integer'],
            [['first_name', 'middle_name', 'last_name', 'birth_place', 'nationality'], 'string', 'max' => 50],
