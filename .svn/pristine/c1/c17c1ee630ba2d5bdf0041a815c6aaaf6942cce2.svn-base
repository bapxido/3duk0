...
class CourseSearch extends Course
{
    ...
    {
        return [
            [['course_id', 'faculty_id', 'course_type_id', 'create_user_id', 'update_user_id'], 'integer'],
            [['course', 'course_code', 'course_duration', 'remarks', 'record_status', 'create_date', 'update_date'], 'safe'],
        ];
    }
